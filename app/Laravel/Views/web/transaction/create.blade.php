...
<section class="px-120 pt-110 pb-80 gray-light-bg">
    <div class="container">
         <div class="row">
            <div class="col-md-6">
                <h5 class="text-title pt-3"><i class="fa fa-file"></i> E<span class="text-title-two"> SUBMISSION</span></h5>
            </div>
           <div class="col-md-6">
                <a href="{{route('web.transaction.history')}}" class="custom-btn badge-primary-2 text-white m-1" style="float: right;">Application History</a>
                <a href="{{route('web.business.index')}}" class="custom-btn badge-primary-2 text-white m-1" style="float: right;">Business Profile</a>
           </div>
         </div>
